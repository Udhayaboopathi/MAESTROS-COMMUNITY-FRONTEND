...
function UserDetailsModal({ isOpen, onClose, user }: UserDetailsModalProps) {
  ...
  const modalContent = (
    ...
    >
      {/* Backdrop - completely covers main screen */}
      ...
      {isLoading || !userDetails ? (
        ...
        /* Modal Content */
        <div
          className="relative w-full max-w-4xl bg-gradient-to-br from-black-charcoal via-black-deep to-black-charcoal rounded-3xl shadow-2xl max-h-[90vh] overflow-hidden border-2 border-gold/30 z-10"
            ...
            <div className="relative px-8 pt-12 pb-8">
              <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="flex-1 text-center md:text-left">
                  <h2 className="text-4xl font-bold mb-2 text-gold">
                    {displayName}
                  </h2>
  ...
  // Use portal to render modal at document body level, bypassing stacking contexts
